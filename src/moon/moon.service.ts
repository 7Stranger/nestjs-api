...
const MOON_PHASES: Array<IMoonPhase> = [
  ...
  },
  {
    ...
    description:
      'Друга фаза місячного циклу; настає між молодим місяцем і першою чвертю. Зростання фази означають збільшення освітленості Місяця, тому на початку цієї фази Місяць має форму тонкого півмісяця, а потім освітлена область поступово збільшується поки не настає фаза першої чверті.',
  },
  {
